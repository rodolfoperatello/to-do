...
public class TaskEntity {
    ...
    public TaskEntity(Long userid, String description, String status) {
        this.userId = userid;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(userId,
            ...
            that.description) && Objects.equals(status,
            that.status) && Objects.equals(createdAt,
            that.createdAt) && Objects.equals(updatedAt, that.updatedAt);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, userId, description, status, createdAt, updatedAt);
    }
}
